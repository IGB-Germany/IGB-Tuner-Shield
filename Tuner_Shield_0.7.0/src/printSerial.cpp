...
void devicePrintStatus(deviceStatusInformation_t deviceStatusInformation)
{
  ...
  Serial.print(deviceStatusInformation.pUpState);
  ...
  Serial.print(deviceStatusInformation.dacqInt);
  Serial.println(F(" Ensemble IRQ"));
  Serial.print(deviceStatusInformation.dsrvInt);
  Serial.println(F(" Data IRQ"));
  Serial.print(deviceStatusInformation.devNtInt);
  Serial.println(F(" Digital Event IRQ"));
  Serial.print(deviceStatusInformation.stcInt);
  Serial.println(F(" Seek/Tune complete"));
  Serial.print(deviceStatusInformation.cts);
  Serial.println(F(" Clear to Send"));
  Serial.print(deviceStatusInformation.cmdErr);
  Serial.println(F(" Command Error"));
  Serial.print(deviceStatusInformation.dspErr);
  Serial.println(F(" DSP Error"));
  Serial.print(deviceStatusInformation.repOfErr);
  Serial.println(F(" Reply Overflow Error"));
  Serial.print(deviceStatusInformation.cmdOfErr);
  Serial.println(F(" Command Overflow Error"));
  Serial.print(deviceStatusInformation.arbErr);
  Serial.println(F(" Arbiter Error"));
  Serial.print(deviceStatusInformation.nonRecErr);
  Serial.println(F(" Non Recoverable Error"));
  Serial.print(deviceStatusInformation.cmdErrCode);
...
{
  Serial.println(F("Firmware Image Mode"));
  Serial.print(deviceImage);
...
void dabPrintMenuMain()
{
  ...
  Serial.println(F("+: Next Service"));
  Serial.println(F("-: Previous Service"));
  Serial.println();
