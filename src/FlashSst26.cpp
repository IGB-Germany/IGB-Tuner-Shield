...
FlashSst26::FlashSst26(uint8_t slaveSelectPin, uint32_t  frequency, uint8_t dataOrder, uint8_t dataMode)
...
bool FlashSst26::readByte(unsigned long adressStart, unsigned char data[])
{
  unsigned char cmd[4];
  ...
  _comDriverSpi.writeSpi(cmd, sizeof(cmd), ComDriverSpi::transferStart);
  _comDriverSpi.readSpi(data, sizeof(data[0]), ComDriverSpi::transferEnd);
...
bool FlashSst26::writeByte(unsigned long adressStart, unsigned char data[])
{
  unsigned char cmd[5];
...
bool FlashSst26::readPage(unsigned long addressStart, unsigned char page[])
{
...
bool FlashSst26::writePage(unsigned long addressStart, unsigned char page[])
{
  /*Adress has to start at begin of page*/
...
bool FlashSst26::readData(unsigned long adressStart, unsigned char data[], unsigned long lenData)
{
  unsigned char cmd[4];
...
bool FlashSst26::writeData(unsigned long addressStart, unsigned char data[], unsigned long lenData)
{
  /*Adress has to start at begin of page*/
  if (addressStart % _sizePage != 0) return false;
...
bool FlashSst26::erase4kByte(unsigned long addressStart)
{
...
/*Erase Block 8kByte*/
bool FlashSst26::erase8kByte(unsigned long addressStart)
{
...
/*Read security data*/
unsigned char FlashSst26::readSecurityData(unsigned long addressStart)
{
